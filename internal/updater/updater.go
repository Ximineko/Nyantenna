...
func ApplyUpdate() error {
	...
	// 拼接对应的 asset name。例如: nyantenna_v1.0.0_linux_amd64
	targetGoos := runtime.GOOS
	targetGoarch := runtime.GOARCH
	if targetGoarch == "arm" {
		targetGoarch = "armv7" // 根据 Makefile 中的定义，nyantenna 编的 arm 是 armv7
	}

	binaryName := "nyantenna"
