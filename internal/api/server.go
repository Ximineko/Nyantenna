...
import (
	...
	"github.com/ximineko/nyantenna/internal/data/repo"
	"github.com/ximineko/nyantenna/internal/db"
	"github.com/ximineko/nyantenna/internal/device"
	"github.com/ximineko/nyantenna/internal/global"
	...
	vwebsheet "github.com/ximineko/nyantenna/internal/websheet"
...
func (s *Server) handleListDevices(c *gin.Context) {
	...
	type DeviceStatus struct {
		...
		// BackendMode 让前端能区分读卡器与模组设备（能力集差别很大）
	...
	for _, w := range workers {
		...
		if w.Backend != nil {
			item.BackendMode = w.Backend.Mode()
		}
		// 添加格式化流量
		if w.Proxy != nil {
