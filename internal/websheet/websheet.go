...
func callbackHTML() string {
	return `<!doctype html><html><body><script>try{window.parent.postMessage({type:"nyantenna-websheet-callback"},"*")}catch(_){}</script>Carrier flow returned to Nyantenna.</body></html>`
}
